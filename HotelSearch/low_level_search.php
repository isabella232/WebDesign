...
<head>
  <head>
      ...
      <script type="text/javascript" src="js/low_level_search.js"></script>
  <style>
			...
			<div class="wrapper">
				<form action="low_level_search.php" method="post">
					<div class="search_fields">
						<input class="float" type="text" id="keywords" name="location" value="<?php echo $location; ?>"  autocomplete="off">
              ...
              <li>
                ...
                <div class="property_details">
                  ...
                  if($single_availability*1 + $double_availability*2 < $people_count){
                    ?>
                    <h1> <span class="property_size"><b>SOLD OUT!!</b></span></h1>
                    <?php
                  }
                  else{
                    ...
                    ?>
                    <h1> <span class="property_size">Estimated total: <b>$<?php echo $total_price ?> </b></span></h1>
